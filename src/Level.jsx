...
export function BlockEnd({ position = [0, 0, 0] }) {
    const star = useGLTF('/assets/star.glb')
    const starTexture = useTexture('/assets/starBaked.jpg')
    ...
    return <group position={position}>
        ...
        <Float speed={5} floatIntensity={5} rotationIntensity={5}>
            <RigidBody type="fixed" colliders="hull" position={[0, 2, 0]} scale={0.25} rotation-x={Math.PI / 2} restitution={0.2} friction={0}>
                <mesh geometry={star.nodes.baked.geometry}>
